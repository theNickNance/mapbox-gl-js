 ...
 * @param {PointLike=} options.offset The offset in pixels as a {@link PointLink} object to apply relative to the element's center. Negatives indicate left and up.
 * @example
